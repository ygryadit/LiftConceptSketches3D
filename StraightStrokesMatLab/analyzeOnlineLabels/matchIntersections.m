...
for i = 1:size(intersections.strokes_indices,1)
   if  intersections.strokes_indices(i,1) > intersections.strokes_indices(i,2)
       temp = intersections.strokes_indices(i,1);
       intersections.strokes_indices(i,1) = intersections.strokes_indices(i,2);
       intersections.strokes_indices(i,2) = temp;
   end
end
