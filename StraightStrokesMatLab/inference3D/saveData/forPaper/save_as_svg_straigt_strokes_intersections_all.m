function save_as_svg_straigt_strokes_intersections_all(strokes, intersections, folder_save, sketch_height, name)
...
for i = 1:length(intersections)
    ...
    str = sprintf(' <circle cx="%.3f" cy="%.3f" r="%.3f" stroke="black" fill-opacity="0.5" fill="rgb(%d, %d, %d)" /> \n',...
                ...
                intersections(i).accuracy_radius,...                
                color(1),...
                color(2),...
                color(3));   
   fwrite(fid, str);           
