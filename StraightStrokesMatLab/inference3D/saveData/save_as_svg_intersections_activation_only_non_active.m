function save_as_svg_intersections_activation_only_active(strokes_topology, intersections, folder_save, sketch_height)
global IPad;
%% Normilize pressure:
...
filepath = fullfile(folder_save, 'intersections_active_only_non_active.svg');
