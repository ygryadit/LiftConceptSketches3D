function distances = pointLineDistance3DPerspective(p, pl1, pl2, cam_param)
...
%     plot3(P_intersect(1), P_intersect(2), P_intersect(3), 'c*')
    distances(i) = norm(p(i,:) - P_intersect);
