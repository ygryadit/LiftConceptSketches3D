...
%   intersection strictly towards vanishing point.
...
function candidate_lines...
    ...
    for i = 1:length(inds_intrsctns_assigned)
        ...
        candidate_lines(i) = createOneCandidateLine(cat(1,intersections(inds_intrsctns_assigned(i)).coordinates3D),...
                                                    direction_prior,...
...
%                fprintf(2, 'It seems that the intersection in the line below shoulf be already computed');
               ...
               [inter_coord_3D, ~] = ...
                ...
                candidate_lines(lines_ind) = createOneCandidateLine(inter_coord_3D,...
                                                    direction_prior,...
                                                    cur_stroke.primitive_geom,...
                                                    cam_param.P,...
                                                    indcs_intrsctns,...
