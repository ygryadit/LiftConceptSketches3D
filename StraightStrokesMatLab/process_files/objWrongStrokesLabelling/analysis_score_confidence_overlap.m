...
for i = 1:size(list_designers_paper_14,1)
   ...
   percentage_low_score_dave_14(i) = computePecentageLowScoreAssignedLast(set_removed, strokes_topology_rough);
   
   
   set_removed = strokes_numbers_jerry_removed{i};
   percentage_low_score_jerry_14(i) = computePecentageLowScoreAssignedLast(set_removed, strokes_topology_rough);
...
for i = 1:size(list_designers_supplemental,1)
   ...
   pcl = computePecentageLowScoreAssignedLast(set_removed, strokes_topology_rough);
