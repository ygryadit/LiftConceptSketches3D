function save_as_svg_straigt_strokes_intersect(strokes,intersections,solution, agrement, folder_save, sketch_height, name)
...
for i = 1:length(inds_intersect)
  ...
  coord = findClosestTwoPointsStroke( strokes(strk_indices(1)).points,...
                                    intersections.coordinates2D(inds_intersect(i),:)); 
...
%   
   ...
   coord = findClosestTwoPointsStroke( strokes(strk_indices(2)).points,...
                                    intersections.coordinates2D(inds_intersect(i),:));
