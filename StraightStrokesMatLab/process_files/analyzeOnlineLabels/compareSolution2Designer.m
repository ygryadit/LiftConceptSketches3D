function [percentage_agrees, avg_nd_agreemnt_match_designer, avg_nd_agreemnt_nmatch_designer, solution] = compareSolution2Designer(solution_ref, agrement_ref, task)
